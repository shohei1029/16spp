...
NAME_CORE=$1
DOMAIN=$2
TARGET_REGION_TYPE=$3

DIR_NAME_CORE="${TARGET_REGION_TYPE}_${NAME_CORE}"
DETAILED_NAME_CORE="${DOMAIN}_${TARGET_REGION_TYPE}-HXB2-Pfam_${NAME_CORE}"
...
cd $BLASTDB
makeblastdb -in ${DETAILED_NAME_CORE}.fasta -dbtype prot -hash_index -parse_seqids -max_file_sz 2GB
