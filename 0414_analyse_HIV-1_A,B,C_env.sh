...
python getseq_ingbk_withbginfo_tofasta.py -t env -m s -s A1,A2,B,C | python filter_fasta_by_seq-length.py -n True -r 856 > $FASTA_FILE
...
blastp -query ${FASTA_FILE} -db ${NAME_CORE}.fasta -num_threads 128 -outfmt 7 -evalue 1e-5 -max_target_seqs 99999999 -out ${OUTPUT_FILE}
