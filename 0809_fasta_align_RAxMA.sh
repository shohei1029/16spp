...
NAME_CORE="2seqs_eachcluster_scps-c5_blastp_1e-5_A,B,C_HIV-1-gM-noRs_pol-aa_v3"
...
raxmlHPC-PTHREADS-SSE3 -f a -p 12345 -x 12345 -m PROTGAMMAAUTO -N 1000 -s ${ALIGNED_FASTA} -w ${RAXML_OUTDIR} -n ${NAME_CORE} -T 8
